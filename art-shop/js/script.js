...
document.querySelector('.basket').onmousedown = function () {
  let basketBlock = document.querySelector('.my-basket');
  basketBlock.style.display = 'block';
}

document.querySelector('.fa-angle-left').onmousedown = function () {
  let basketNone = document.querySelector('.my-basket');
  basketNone.style.display = 'none';
}